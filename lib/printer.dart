...
final flutterPrinterChannel =
    const MethodChannel('com.smart.smart_bluetooth_pos_printer');
final flutterPrinterEventChannelBT =
    const EventChannel('com.smart.smart_bluetooth_pos_printer/bt_state');
final iosChannel = const MethodChannel('smart_bluetooth_pos_printer/methods');
final iosStateChannel = const EventChannel('smart_bluetooth_pos_printer/state');
